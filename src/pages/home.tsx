  ...
  return (
    <div className="flex flex-col min-h-screen">
      <section className="relative min-h-[100dvh] flex items-center justify-center pt-20 overflow-hidden">
        ...
        <div className="container relative z-10 mx-auto px-4 py-20 text-center flex flex-col items-center">
          ...
          <motion.h1 initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7, delay: 0.2 }} className="text-4xl md:text-6xl lg:text-7xl font-extrabold text-white mb-8 leading-tight tracking-tight max-w-5xl mx-auto drop-shadow-2xl">
            ...
            <span className="bg-gradient-to-r from-cyan-400 to-blue-500 bg-clip-text text-transparent">Sourcing & Cost Optimization</span>
          </motion.h1>
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7, delay: 0.6 }} className="flex flex-col sm:flex-row items-center justify-center gap-6 w-full max-w-lg">
            <Link href="/contact" className="w-full sm:w-auto px-8 py-4 bg-cyan-500 text-black font-bold rounded-full hover:bg-cyan-400 transition-all shadow-[0_0_20px_rgba(34,211,238,0.3)] hover:shadow-[0_0_40px_rgba(34,211,238,0.6)] text-center">TALK TO AN EXPERT</Link>
            <Link href="/solutions" className="w-full sm:w-auto px-8 py-4 bg-white/5 border border-white/20 text-white font-medium rounded-full hover:bg-white/10 transition-all backdrop-blur-md text-center">EXPLORE SOLUTIONS</Link>
          </motion.div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-2 lg:grid-cols-5 gap-4 md:gap-6">
            {metrics.map((metric, i) => (
              <motion.div key={i} initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: i * 0.1 }} className="bg-white/5 backdrop-blur-md border border-white/10 p-6 rounded-2xl text-center shadow-lg hover:border-cyan-500/30 transition-colors">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6">
            {whyReasons.map((reason, i) => (
              <motion.div key={i} initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: i * 0.05 }} className="bg-white/5 backdrop-blur-md border border-white/10 p-6 rounded-2xl hover:shadow-[0_0_30px_rgba(34,211,238,0.15)] transition-all group hover:-translate-y-1">
                <div className="w-12 h-12 rounded-full bg-cyan-500/10 flex items-center justify-center mb-6 group-hover:bg-cyan-500/20 transition-colors text-cyan-400"><reason.icon size={24} /></div>
      ...
      <section className="py-24 bg-[#060d1a] border-t border-white/5">
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-6">
            <div><h2 className="text-3xl md:text-5xl font-bold mb-6">Our Core Services</h2><div className="w-24 h-1 bg-cyan-500 rounded-full"></div></div>
            <Link href="/services" className="text-cyan-400 hover:text-cyan-300 font-medium flex items-center gap-2 pb-2">View All Services <ArrowRight size={16} /></Link>
          </div>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            {services.map((service, i) => (
              <motion.div key={i} initial={{ opacity: 0, scale: 0.95 }} whileInView={{ opacity: 1, scale: 1 }} viewport={{ once: true }} transition={{ delay: i * 0.1 }} className="bg-white/5 backdrop-blur-md border border-white/10 p-8 rounded-2xl group hover:border-cyan-500/50 transition-all flex flex-col sm:flex-row gap-6 items-start">
                <div className="text-cyan-400 font-mono text-xl font-bold bg-cyan-400/10 w-16 h-16 rounded-xl flex items-center justify-center shrink-0">0{i + 1}</div>
                <div>
                  ...
                  <Link href="/services" className="text-cyan-400 font-medium group-hover:text-cyan-300 flex items-center gap-2 text-sm">Learn More <ArrowRight size={16} /></Link>
                </div>
              </motion.div>
            ))}
          </div>
      ...
      <section className="py-24 bg-[#030812] border-t border-white/5 overflow-hidden">
        <div className="container mx-auto px-4">
          <div className="text-center mb-20"><h2 className="text-3xl md:text-5xl font-bold mb-6">Our Engagement Process</h2><div className="w-24 h-1 bg-cyan-500 mx-auto rounded-full"></div></div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-6 gap-8 relative z-10">
              {processSteps.map((step, i) => (
                <motion.div key={i} initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: i * 0.1 }} className="flex flex-col items-center text-center group">
                  <div className="w-16 h-16 bg-[#030812] border-2 border-cyan-500 rounded-full flex items-center justify-center text-cyan-400 font-bold mb-6 shadow-[0_0_15px_rgba(34,211,238,0.2)] group-hover:scale-110 transition-transform group-hover:bg-cyan-500 group-hover:text-black">{step.num}</div>
      ...
      <section className="py-24 bg-[#060d1a] border-t border-white/5">
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-6">
            <div><h2 className="text-3xl md:text-5xl font-bold mb-6">Solutions We Deliver</h2><div className="w-24 h-1 bg-cyan-500 rounded-full"></div></div>
            <Link href="/solutions" className="text-cyan-400 hover:text-cyan-300 font-medium flex items-center gap-2 pb-2">View All Solutions <ArrowRight size={16} /></Link>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {solutions.map((solution, i) => (
              <motion.div key={i} initial={{ opacity: 0, y: 10 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: i * 0.05 }} className="bg-white/5 backdrop-blur-md border border-white/10 p-5 rounded-xl group hover:border-cyan-400/50 transition-all flex items-center justify-between">
                <div><h4 className="font-bold text-white group-hover:text-cyan-400 transition-colors text-sm">{solution}</h4><p className="text-xs text-white/50 mt-1">Expert execution</p></div>
                <div className="w-8 h-8 rounded-full bg-cyan-500/10 flex items-center justify-center text-cyan-400 opacity-0 group-hover:opacity-100 transition-opacity"><ArrowUpRight size={14} /></div>
              </motion.div>
            ))}
          </div>
        </div>
      ...
      <section className="py-24 bg-[#030812] border-t border-white/5">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16"><h2 className="text-3xl md:text-5xl font-bold mb-6">Industries We Transform</h2><div className="w-24 h-1 bg-cyan-500 mx-auto rounded-full"></div></div>
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
            {industries.map((ind, i) => (
              <motion.div key={i} initial={{ opacity: 0, scale: 0.95 }} whileInView={{ opacity: 1, scale: 1 }} viewport={{ once: true }} transition={{ delay: i * 0.05 }} className="bg-white/5 border border-white/10 p-6 rounded-2xl hover:bg-white/10 hover:border-white/20 transition-all text-center flex flex-col items-center group">
                <div className="text-cyan-400 mb-4 group-hover:scale-110 transition-transform"><ind.icon size={28} /></div>
      ...
      <section className="py-24 bg-[#060d1a] border-t border-white/5 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center mb-16"><h2 className="text-3xl md:text-5xl font-bold mb-6">Delivering Measurable Impact</h2><div className="w-24 h-1 bg-cyan-500 mx-auto rounded-full"></div></div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
            {impactData.map((impact, i) => (
              <motion.div key={i} initial={{ opacity: 0, scale: 0.95 }} whileInView={{ opacity: 1, scale: 1 }} viewport={{ once: true }} transition={{ delay: i * 0.1 }} className="bg-[#030812] border border-white/10 rounded-2xl p-8 relative overflow-hidden group hover:border-cyan-500/50 transition-colors shadow-xl">
      ...
      <section className="py-24 bg-[#030812] border-t border-white/5">
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-6">
            <div><h2 className="text-3xl md:text-5xl font-bold mb-6">Training & Capability</h2><div className="w-24 h-1 bg-cyan-500 rounded-full"></div></div>
            <Link href="/trainings" className="text-cyan-400 hover:text-cyan-300 font-medium flex items-center gap-2 pb-2">Explore Programs <ArrowRight size={16} /></Link>
          </div>
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            {trainingCategories.map((cat, i) => (
              <motion.div key={i} initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: i * 0.1 }} className="bg-white/5 border border-white/10 p-8 rounded-3xl hover:border-cyan-500/30 transition-all flex flex-col group">
                <div className="w-14 h-14 bg-cyan-500/10 rounded-2xl flex items-center justify-center text-cyan-400 mb-6 group-hover:bg-cyan-500 group-hover:text-black transition-colors"><cat.icon size={28} /></div>
                <h3 className="text-xl font-bold mb-4">{cat.title}</h3>
                <p className="text-white/70 mb-8 flex-1">{cat.desc}</p>
                <Link href="/trainings" className="mt-auto px-6 py-3 border border-white/20 text-white text-sm font-bold rounded-full hover:bg-white/10 text-center transition-all">Learn More</Link>
              </motion.div>
            ))}
          </div>
        </div>
      ...
      <section className="py-24 bg-[#060d1a] border-t border-white/5">
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-6">
            <div><h2 className="text-3xl md:text-5xl font-bold mb-6">Insights & Thought Leadership</h2><div className="w-24 h-1 bg-cyan-500 rounded-full"></div></div>
            <Link href="/insights" className="text-cyan-400 hover:text-cyan-300 font-medium flex items-center gap-2 pb-2">View All Insights <ArrowRight size={16} /></Link>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {insightsPreview.map((article, i) => (
              <motion.div key={i} initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: i * 0.1 }} className="bg-white/5 border border-white/10 rounded-2xl overflow-hidden hover:border-cyan-500/40 transition-all group flex flex-col h-full">
                ...
                <div className="p-8 flex flex-col flex-1">
                  ...
                  <Link href="/insights" className="text-sm font-medium text-white/60 group-hover:text-cyan-400 mt-auto flex items-center gap-2">Read More <ArrowRight size={16} /></Link>
                </div>
              </motion.div>
            ))}
          </div>
        ...
        <div className="container mx-auto px-4 relative z-10 text-center">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-6">
              <Link href="/contact" className="px-10 py-5 bg-cyan-500 text-black text-lg font-bold rounded-full hover:bg-cyan-400 transition-all shadow-[0_0_30px_rgba(34,211,238,0.3)] hover:shadow-[0_0_50px_rgba(34,211,238,0.5)]">TALK TO AN EXPERT</Link>
              <Link href="/solutions" className="px-10 py-5 border border-white/20 text-white text-lg font-medium rounded-full hover:bg-white/10 transition-all backdrop-blur-sm">EXPLORE SOLUTIONS</Link>
            </div>
          </motion.div>
        </div>
      </section>
