        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            ...
            <p className="text-xl text-white/70 leading-relaxed mb-8">
              CEVENIQ Strategic Solutions is built at the intersection of engineering depth and commercial intelligence. We help organizations make smarter automation investment decisions, source globally with confidence, and deploy industrial projects with precision and efficiency.
            </p>
            <p className="text-lg text-white/60 max-w-2xl mx-auto">
              Led by professionals with extensive experience in industrial automation, strategic procurement, cost engineering, and global supply chain operations.
            </p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-24 bg-[#030812]">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold mb-4">Our Foundational Pillars</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              <motion.div
                ...
                className="bg-white/5 backdrop-blur-md border border-white/10 p-8 rounded-2xl hover:border-cyan-500/30 transition-all flex flex-col h-full"
              >
      ...
      <section className="py-24 bg-[#060d1a] border-t border-white/5">
        <div className="container mx-auto px-4">
          <motion.div 
            ...
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            className="max-w-4xl mx-auto bg-gradient-to-br from-cyan-900/20 to-blue-900/10 border border-cyan-500/20 p-12 rounded-3xl text-center relative overflow-hidden"
          >
            <div className="absolute top-0 right-0 p-8 opacity-10">
              <svg width="100" height="100" viewBox="0 0 24 24" fill="none" stroke="cyan" strokeWidth="1"><path d="M12 2L2 7l10 5 10-5-10-5zM2 17l10 5 10-5M2 12l10 5 10-5"/></svg>
            </div>
            <h2 className="text-3xl font-bold mb-6 text-white">Our Mission</h2>
            <p className="text-2xl leading-relaxed text-white/90 font-medium">
              "CEVENIQ combines engineering intelligence with commercial strategy to deliver scalable, practical, and cost-effective industrial transformation solutions."
            </p>
          </motion.div>
          ...
          <div className="mt-24">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 max-w-4xl mx-auto">
              {[
                "Warehouse Automation Advisory",
                "Industrial Cost Engineering",
                "Global Vendor Benchmarking",
                "Strategic China Sourcing",
                "ASRS & AMR Deployments",
