  ...
  return (
    <div className="flex flex-col min-h-screen pt-20">
      <section className="py-24 bg-[#060d1a] border-b border-white/5">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl text-white/70 max-w-3xl mx-auto">
            Targeted capabilities for complex industrial challenges.
          </p>
        </div>
      </section>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                {cat.items.map((sol, j) => (
                  <motion.div 
                    ...
                    className="bg-white/5 border border-white/10 p-8 rounded-2xl hover:border-cyan-400/50 transition-all group flex flex-col h-full"
                  >
      ...
      <section className="py-24 bg-[#060d1a] border-t border-white/5 relative overflow-hidden">
        <div className="absolute inset-0 bg-cyan-900/10 blur-3xl rounded-full translate-y-1/2"></div>
        <div className="container mx-auto px-4 text-center relative z-10">
          <h2 className="text-3xl md:text-4xl font-bold mb-8">Don't See What You Need?</h2>
          <p className="text-xl text-white/70 max-w-2xl mx-auto mb-10">
            Our engineering intelligence team develops bespoke solutions for unique industrial requirements.
          </p>
