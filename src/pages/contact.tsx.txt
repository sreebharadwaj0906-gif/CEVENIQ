            ...
            <div className="lg:col-span-1 space-y-12">
                ...
                <div className="space-y-8">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <a href="mailto:askme@ceveniq.com" className="text-lg hover:text-cyan-400 transition-colors font-medium">
                        askme@ceveniq.com
                      </a>
                    </div>
                  </div>
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <a href="tel:+919187091728" className="text-lg hover:text-cyan-400 transition-colors font-medium">
                        +91-9187091728
                      </a>
                    </div>
                  </div>
              ...
              <div className="pt-8 border-t border-white/10">
                ...
                <a
                  ...
                  className="inline-flex items-center justify-center gap-3 w-full px-6 py-4 bg-green-500 text-white font-bold rounded-xl hover:bg-green-400 transition-colors shadow-lg"
                >
            ...
            <div className="lg:col-span-2">
              {submitted ? (
                <motion.div
                  ...
                  className="bg-white/5 border border-cyan-500/30 rounded-3xl p-16 text-center h-full flex flex-col items-center justify-center"
                >
                  ...
                  <p className="text-white/70 text-xl max-w-md mx-auto leading-relaxed">
                    Thank you for reaching out. Our engineering intelligence team will review your requirements and contact you within 24 hours.
                  </p>
                </motion.div>
              ) : (
                    ...
                    <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6 relative z-10">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <FormField
                          ...
                          render={({ field }) => (
                            <FormItem>
                              <FormLabel className="text-white/80">Designation *</FormLabel>
                              <FormControl>
                      ...
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem>
                            <FormLabel className="text-white/80">Current Challenges *</FormLabel>
                            <FormControl>
                              <Textarea
                      ...
                      <Button
                        ...
                        className="w-full h-14 bg-cyan-500 hover:bg-cyan-400 text-black font-bold text-lg rounded-xl transition-all mt-4"
                      >
